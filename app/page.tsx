...
export default function Home() {
  ...
  return (
    <main className="min-h-screen relative overflow-hidden flex flex-col">
      {/* Cosmic Background - Dark Space (lighter version) */}
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <section className="flex-grow flex flex-col justify-center items-center py-8 px-4">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 text-center border border-white/30 shadow-2xl mb-6 w-full max-w-md">
            <p className="text-lg text-white mb-2 font-medium">People who paid $1</p>
          ...
          <div className="text-center text-sm text-gray-300 mt-6 max-w-md">
            <p className="mb-2">
              <span className="text-blue-400 font-bold">$1</span> - Pay & see the count
            </p>
            <p>
              <span className="text-purple-400 font-bold">$2</span> - Leave your name & message
            </p>
          </div>
        </section>
